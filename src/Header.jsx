...
function Header(props) {
  return (
    <div className=" shadow-lg   flex sticky top-0 bg-white w-full justify-between p-5 items-center">
      ...
      <ul className=" invisible fixed md:visible md:sticky flex justify-evenly  grow font-medium">
        <Link to="/HomePage" className="hover:text-red-500">
          Home
        </Link>
        <Link to="/ServicePage" className="hover:text-red-500">
          Service
        </Link>
        <Link to="/WorkProject" className="hover:text-red-500">
          Project
        </Link>
        <Link to="/ContactLast" className="hover:text-red-500">
          Contact us
        </Link>
      </ul>
