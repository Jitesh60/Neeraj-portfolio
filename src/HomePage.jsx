...
function HomePage() {
    return (
        <div className="bg-gray-200  flex-col md:flex overflow-hidden p-16 justify-center items-between">
            <div className="p-5">
              <h1 className="text-xl bg-transparent text-red-500  mb-3 md:mb-16">GET EVERY SINGLE SOLUTIONS.</h1>
