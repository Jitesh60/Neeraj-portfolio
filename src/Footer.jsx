...
function Footer() {
  return (
    <div className="flex-col justify-center md:flex md:items-center justify-between">
      <div className="flex">
        <h1 className=" flex-col  md:flex md:items-center text-slate-700">
          Copyright ©2022 All rights reserved | This Portfolio is made with
          <span className="ml-2 flex items-center mb-2 mr-2 text-red-500">
            <BsHeartFill />
          </span>
          <a
